  ...
  return (
    <Aux>
      <div className="modal__container">
        ...
        <button onClick={() => window.open(props.movie.link, '_blank')} className="modal__btn modal__btn--red">
          <PlayIcon className="modal__btn--icon" />
          Play
        </button>
        <button onClick={() => window.open(props.movie.link, '_blank')} className="modal__btn">
